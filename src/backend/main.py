...
async def lifespan(app: FastAPI):
    ...
    recipe_agent = RecipeAgent(
        knowledge_agent=knowledge_agent,
        meal_planner_agent=None  # will link later
    )

    # Meal Planner gets knowledge agent and user agent
    ...
    # Link meal planner to recipe agent (circular dependency)
    recipe_agent.meal_planner = meal_planner_agent
    meal_planner_agent.recipe_agent = recipe_agent
